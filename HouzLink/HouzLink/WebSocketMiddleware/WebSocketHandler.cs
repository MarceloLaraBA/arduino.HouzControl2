...
namespace HouzLink.WebSocketMiddleware
{
    public abstract class WebSocketHandler
    {
        ...
        public virtual async Task OnDisconnected(WebSocket socket) => await WebSocketConnectionManager.RemoveSocket(WebSocketConnectionManager.GetId(socket)).ConfigureAwait(false);
